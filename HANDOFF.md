...
- 径向重映射 S3：本条分支 `cursor/radial-s3-physics-84d9`（叠在 `cursor/radial-s2c-qc-84d9` 上）。隔离 `nf-radial-physics.js`，全开关，60/120Hz。#3/#4/#6/#8 过；#5 中心振荡 1.68s，未改 k/c。现网弹簧 / ticker / 100k 未动。证据 `painting/radial-s3.json`。
