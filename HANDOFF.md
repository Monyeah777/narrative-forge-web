...
手册 **§5 已完成**（真机试炼 / bench.html 协议）。B4 / B4.1 已过闸。自动放映修订包 §9.0–§9.6 已交付。不要开轨道 B，下一本是手册 **§6 总验收**，等用户说「继续」。
...
3. 只做用户这一次点名的事。规格里未点名的轨道 B、Fusion Pixel，先问。自动放映修订包 §9.0–§9.6 已交付；下一本是手册 §6 总验收，等用户说「继续」。
